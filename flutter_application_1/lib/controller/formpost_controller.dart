...
class FormPostController {
  ...
  static const String URLGetStock =
      "https://script.google.com/macros/s/AKfycbxMT8I7oGA18NwXVG6WJCNeyUcsFk9sWqbjqEAIAtt9psQ7uOLkLW36WPBgrxcQ1OJAuQ/exec"; // API Get Stock
  ...
  void submitForm(
    ...
    try {
      String txtParams =
          "$URLApiByOne?val1=${DateFormat('dd-MM-yyyy').format(DateTime.now())}&val2=${feedbackForm.val2}&val3=${feedbackForm.val3}&val4=${feedbackForm.val4}&val5=${feedbackForm.val5}&val6=${feedbackForm.val6}&val7=${feedbackForm.val7}&val8=${feedbackForm.val8}&val9=${feedbackForm.val9}&val10=${feedbackForm.val10}&val11=${feedbackForm.val11}&val12=${feedbackForm.val12}&val13=${feedbackForm.val13}&val14=${feedbackForm.val14}&val15=${feedbackForm.val15}&val16=${feedbackForm.val16}&val17=${feedbackForm.val17}&val18=${feedbackForm.val18}&val19=${feedbackForm.val19}&val20=${feedbackForm.val20}&val21=${feedbackForm.val21}&val22=${feedbackForm.val22}&val23=${feedbackForm.val23}&val24=${feedbackForm.val24}&val25Post=${feedbackForm.val25Post}";
